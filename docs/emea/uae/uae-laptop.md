...
layout: default
title: Laptop 
permalink: /uae/laptop
description: UAE Regulations (Laptop)
parent: United Arab Emirates (UAE)
grand_parent: Europe, the Middle East and Africa (EMEA) 
nav_order: 1
---
...
United Arab Emirates (UAE) Regulations </h1>
...
- ***Energy Efficiency:*** <br> Out of scope
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td rowspan=5>
                <img src="https://lh3.googleusercontent.com/drive-viewer/AK7aPaDcgmUtL_93VlLNuq34mD9h3LCmeEjUJ55wBXBoCpgUqs1jXnA0ShkyDb_Ugw5a9SAptQcv7scNjfSpsxpc4qU6L-vXEg=s2560" class="center-eighty"/>
            </td>
            <td rowspan=5>
                <div>
                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill=red class="bi bi-exclamation-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/></svg>&nbsp;Packaging
                </div>
                <div style="white-space: nowrap;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z"/></svg>&nbsp;User Manual
                </div>
                <div>
        ...
        <tr>
            <td>
                ...
                <ul>
                    <li style="white-space: nowrap;">EN 55032 / EN 55035</li>
                </ul>        
            </td>
        </tr>
        <tr>
            <td>
                ...
                <ul>
                    <li style="white-space: nowrap;">ETSI EN 300328 / ETSI EN 301489-1</li>
                </ul>
            </td>
        </tr>
        <tr>
