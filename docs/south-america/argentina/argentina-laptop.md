...
layout: default
title: Laptop 
permalink: /arg/laptop
description: ARG Regulations (Laptop)
parent: Argentina (ARG)
grand_parent: South America
nav_order: 1
---
...
- ***Product Safety:*** <br> IEC 62368-1
- ***Electromagnetic Compatibility (EMC):*** <br> Covered in RF Report
- ***Radio Frequency (RF):*** <br> ENACOM Resolutions (RAMATEL) <br> FCC/RED report could be accepted
- ***Specific Absorption Rate (SAR):*** <br> Covered in RF Report
- ***Energy Efficiency:*** <br> Not in scope
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td rowspan=5>
                <img src="https://lh3.googleusercontent.com/drive-viewer/AK7aPaBMEjuF2GMzLoOaAXgKcaor75SByoq7XC2B70M8R0V09OH2moOIvRxyUEGRWg0GzijXzX4HzUueBMBSlt5Pd39_8IPA=s2560" class="center-seventy"/>
            </td>
            <td rowspan=5>
                <div>
        ...
        <tr>
            <td>
                ...
                <ul>
                    <li>ENACOM Resolutions (RAMATEL)</li>
                    <li>FCC/RED Report could be accepted</li>
                </ul>
            </td>
        </tr>
        <tr>
